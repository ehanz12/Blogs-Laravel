        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <x-nav-link href="/Sosial" :active=" request()->is('Sosial') ">Sosial Mdia</x-nav-link>
    ...
    <div x-show="isOpen" class="md:hidden" id="mobile-menu">
      <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
        ...
        <x-nav-link href="/" :active="request()->is ('/')" >Home</x-nav-link>
              <x-nav-link href="/Blogs" :active="request()->is ('Blogs')" >Blog</x-nav-link>
              <x-nav-link href="/Sosial" :active="request()->is ('Sosial')" >Contact</x-nav-link>
              <x-nav-link href="/Contact" :active="request()->is ('Contact')" >Sosial Media</x-nav-link>
      </div>
